...
export const FISHING_PROFIT_ITEMS = [
    ...
    },
    {
        ...
        itemDisplayName: `${COMMON}Golden Apple`,
        npcPrice: 8,
    },
    {
        itemId: 'ENCHANTED_GOLDEN_APPLE',
        itemName: 'Enchanted Golden Apple',
        itemDisplayName: `${UNCOMMON}Enchanted Golden Apple`,
        npcPrice: 125,
    },
    {
    ...
    {
        itemId: 'MINNOW_BAIT',
        itemName: 'Minnow Bait',
        itemDisplayName: `${COMMON}Minnow Bait`,
        npcPrice: 12,
    },
    {
        itemId: 'DARK_BAIT',
    ...
    {
        itemId: 'SPOOKY_BAIT',
        itemName: 'Spooky Bait',
        itemDisplayName: `${COMMON}Spooky Bait`,
        npcPrice: 10,
    },
    {
        itemId: 'LIGHT_BAIT',
        itemName: 'Light Bait',
        itemDisplayName: `${COMMON}Light Bait`,
        npcPrice: 16,
    },
    {
        itemId: 'SPIKED_BAIT',
        itemName: 'Spiked Bait',
        itemDisplayName: `${COMMON}Spiked Bait`,
        npcPrice: 20,
    },
    {
        itemId: 'FISH_BAIT',
        itemName: 'Fish Bait',
        itemDisplayName: `${COMMON}Fish Bait`,
        npcPrice: 20,
    },
    {
        itemId: 'CARROT_BAIT',
        itemName: 'Carrot Bait',
        itemDisplayName: `${COMMON}Carrot Bait`,
        npcPrice: 7,
    },
    {
        itemId: 'CORRUPTED_BAIT',
        itemName: 'Corrupted Bait',
        itemDisplayName: `${COMMON}Corrupted Bait`,
        npcPrice: 1,
    },
    {
        itemId: 'ICE_BAIT',
        itemName: 'Ice Bait',
        itemDisplayName: `${UNCOMMON}Ice Bait`,
        npcPrice: 3,
    },
    {
        itemId: 'BLESSED_BAIT',
        itemName: 'Blessed Bait',
        itemDisplayName: `${UNCOMMON}Blessed Bait`,
        npcPrice: 42,
    },
    {
        itemId: 'SHARK_BAIT',
        itemName: 'Shark Bait',
        itemDisplayName: `${UNCOMMON}Shark Bait`,
        npcPrice: 0,
    },
    {
        itemId: 'GLOWY_CHUM_BAIT',
        itemName: 'Glowy Chum Bait',
        itemDisplayName: `${UNCOMMON}Glowy Chum Bait`,
        npcPrice: 25,
    },
    {
        itemId: 'HOT_BAIT',
        itemName: 'Hot Bait',
        itemDisplayName: `${UNCOMMON}Hot Bait`,
        npcPrice: 30,
    },
    {
        itemId: 'WORM_BAIT',
        itemName: 'Worm Bait',
        itemDisplayName: `${UNCOMMON}Worm Bait`,
        npcPrice: 25,
    },
    {
        itemId: 'GOLDEN_BAIT',
    ...
    {
        itemId: 'FROZEN_BAIT',
        itemName: 'Frozen Bait',
        itemDisplayName: `${RARE}Frozen Bait`,
        npcPrice: 10,
    },
    {
        itemId: 'GOLD_RECORD',
