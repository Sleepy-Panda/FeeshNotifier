...
.addSwitch({
    category: "Items and storages",
    configName: "showOutdatedAttributes",
    title: "Outdated attributes",
    description: "Render obsolete inactive attributes name and level as short abbreviations for every item. The attributes will be rendered with a gray font.",
    subcategory: "Attributes"
})
.addSwitch({
    category: "Items and storages",
    configName: "showAttributesOnShards",
    title: "Shard attributes",
    description: "Render attribute name, rarity and level as short abbreviations for Shards.",
    subcategory: "Attributes"
})
.addTextInput({
    category: "Items and storages",
